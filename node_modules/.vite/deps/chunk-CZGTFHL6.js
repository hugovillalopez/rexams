...
function normalize(map4) {
  ...
  for (let prop in map4)
    copy[normalizeKeyName(prop)] = map4[prop];
  return copy;
}
...
var i2 = (p4, h2, n3) => (H2(p4, h2, "read from private field"), n3 ? n3.call(p4) : h2.get(p4));
var u3 = (p4, h2, n3) => {
  if (h2.has(p4))
    throw TypeError("Cannot add the same private member more than once");
  h2 instanceof WeakSet ? h2.add(p4) : h2.set(p4, n3);
};
var o = (p4, h2, n3, t2) => (H2(p4, h2, "write to private field"), t2 ? t2.call(p4, n3) : h2.set(p4, n3), n3);
var U2 = class {
};
var V2 = class {
  constructor() {
...
var q2 = class q3 extends U2 {
  constructor(h2, n3, t2, s2 = {}) {
    super(), this.type = h2, this.children = n3, this.value = t2, this.props = s2, this.push = (e2, ...r) => {
...
var z = class z2 extends V2 {
  ...
  constructor(n3) {
    ...
    o(this, v, Mark.none), o(this, P2, (t2) => {
      ...
      e2.length && i2(this, N).call(this, "text", void 0, e2);
      const k4 = s2();
      return r.length && i2(this, N).call(this, "text", void 0, r), k4;
    }), o(this, x3, (t2 = false) => {
      const s2 = this.close(), e2 = () => i2(this, N).call(this, s2.type, s2.children, s2.value, s2.props);
      return t2 ? i2(this, R2).call(this, s2, e2) : e2();
    }), this.closeNode = () => (i2(this, x3).call(this), this), o(this, N, (t2, s2, e2, r) => {
      const a2 = W2.create(t2, s2, e2, r), c3 = i2(this, b2).call(this, i2(this, C2).call(this, a2));
      return this.push(c3), c3;
    }), this.addNode = (t2, s2, e2, r) => (i2(this, N).call(this, t2, s2, e2, r), this), o(this, D2, (t2, s2, e2, r) => t2.isInSet(i2(this, v)) ? this : (o(this, v, t2.addToSet(i2(this, v))), this.openNode(s2, e2, { ...r, isMark: true }))), o(this, E2, (t2) => {
...
v = /* @__PURE__ */ new WeakMap(), P2 = /* @__PURE__ */ new WeakMap(), A2 = /* @__PURE__ */ new WeakMap(), S3 = /* @__PURE__ */ new WeakMap(), I2 = /* @__PURE__ */ new WeakMap(), j2 = /* @__PURE__ */ new WeakMap(), b2 = /* @__PURE__ */ new WeakMap(), C2 = /* @__PURE__ */ new WeakMap(), R2 = /* @__PURE__ */ new WeakMap(), x3 = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), D2 = /* @__PURE__ */ new WeakMap(), E2 = /* @__PURE__ */ new WeakMap(), z.create = (n3, t2) => {
  const s2 = new z(n3);
...
var De = {
  strong: (e2, t2, r, i3) => {
    const n3 = e2.marker || r.options.strong || "*", a2 = r.enter("strong"), h2 = r.createTracker(i3);
    let m2 = h2.move(n3 + n3);
    return m2 += h2.move(
    ...
    ), m2 += h2.move(n3 + n3), a2(), m2;
  },
  emphasis: (e2, t2, r, i3) => {
    const n3 = e2.marker || r.options.emphasis || "*", a2 = r.enter("emphasis"), h2 = r.createTracker(i3);
    let m2 = h2.move(n3);
    return m2 += h2.move(
      r.containerPhrasing(e2, {
        before: m2,
...
var Ee = (e2) => (e2.inject(b3, {}).inject(X, []).inject(Z, []).inject(U3, [M4]).record(R3), async () => {
  ...
  e2.set(P3, i3);
  const n3 = Object.fromEntries(e2.get(X).map(([m2, f3]) => [m2, Te(f3)])), a2 = Object.fromEntries(e2.get(Z).map(([m2, f3]) => [m2, Te(f3)])), h2 = new Schema({ nodes: n3, marks: a2 });
...
var Ke = (e2) => (e2.inject(se, "").inject(V3, {}).inject(ie2, (t2) => t2).inject(ne, [$3, H3, Y]).record(J2), async () => {
  await e2.waitTimers(ne);
  const t2 = e2.get(b3), r = e2.get(q4), i3 = e2.get(ue), n3 = e2.get(ie2), a2 = e2.get(N3), h2 = e2.get(se), m2 = ct(h2, r, t2), f3 = [
    ...a2,
    new Plugin({
      key: mt,
      state: {
  ...
  return e2.set(V3, l3), e2.done(J2), () => {
    e2.remove(se).remove(V3).remove(ie2).remove(ne).clearTimer(J2);
  };
});
k3(Ke, {
...
var Ae = (e2) => (e2.inject(me, document.body).inject(L4, {}).inject(ce, {}).inject(we, null).inject(ge, {}).inject(ae, [J2]).record(oe), async () => {
  ...
  const i3 = e2.get(V3), n3 = e2.get(ce), a2 = Object.fromEntries(e2.get(fe)), h2 = Object.fromEntries(e2.get(ye)), m2 = new EditorView(r, {
    state: i3,
    nodeViews: a2,
    markViews: h2,
    ...n3
  ...
  constructor() {
    ...
    c2(this, j3, false), c2(this, p3, "Idle"), c2(this, y3, []), c2(this, D3, () => {
      ...
      if (!a2)
        return;
      const h2 = await a2();
      t2.set(r, { ctx: n3, handler: a2, cleanup: h2 });
...
//# sourceMappingURL=chunk-CZGTFHL6.js.map
