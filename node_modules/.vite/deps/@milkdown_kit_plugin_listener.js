...
var U = (t) => (t.inject(h, new l()), async () => {
  ...
  r.beforeMount.forEach((e) => e(t)), await t.wait(H2);
  const u = t.get(re);
  let n = null, d = null;
  const p = new Plugin({
    key: M2,
  ...
  t.update(N, (e) => e.concat(p)), await t.wait(oe), r.mounted.forEach((e) => e(t));
});
U.meta = {
...
//# sourceMappingURL=@milkdown_kit_plugin_listener.js.map
