...
} from "./chunk-EBKGOMYY.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-3QLGRRGU.js";
import "./chunk-AOW3KBS3.js";
import {
  _extends
...
function map(children, func) {
  let index = 0;
  return React11.Children.map(children, (child) => React11.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React11.Children.forEach(children, (child) => {
    if (React11.isValidElement(child)) func(child, index++);
  });
}
