...
var s = ke("remarkMath", () => remarkMath);
o(s.plugin, {
...
var c = "math_inline";
var m = h({}, "katexOptions");
o(m, {
  displayName: "Ctx<katexOptions>"
});
var l = fe("math_inline", (n) => ({
  group: "inline",
  content: "text*",
  inline: true,
  atom: true,
  ...
  toDOM: (e) => {
    ...
    return t.dataset.type = c, t.dataset.value = a, katex.render(a, t, n.get(m.key)), t;
  },
  parseMarkdown: {
...
var r = fe("math_block", (n) => ({
  ...
  toDOM: (e) => {
    ...
    return t.dataset.type = p, t.dataset.value = a, katex.render(a, t, n.get(m.key)), t;
  },
  parseMarkdown: {
    match: ({ type: e }) => e === "math",
    runner: (e, a, t) => {
