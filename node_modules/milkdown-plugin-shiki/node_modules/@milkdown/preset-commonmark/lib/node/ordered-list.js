...
export const orderedList = createNode((_, utils) => ({
    id,
    schema: {
        content: 'listItem+',
        group: 'block',
        ...
        toDOM: (node) => [
            'ol',
            Object.assign(Object.assign({}, (node.attrs.order === 1 ? {} : node.attrs.order)), { class: utils.getClassName(node.attrs, 'ordered-list') }),
            0,
        ],
    },
    parser: {
